...
const timeline = [
  {
    ...
    role: '資深視覺設計師',
    company: '晨曦創意設計工作室',
    desc: '主導品牌識別設計、視覺系統建立，帶領設計團隊完成多個大型企業品牌專案，並負責與客戶的創意溝通與提案。',
    type: 'work',
  },
  {
    period: '2022 — 2024',
    role: 'UI/UX 設計師',
    company: '明智科技股份有限公司',
    desc: '負責公司旗下多款 App 與 Web 平台的使用者介面設計，推動以用戶為中心的設計文化，參與敏捷開發流程。',
    type: 'work',
  },
  {
    period: '2020 — 2022',
    role: '初級設計師',
    company: '原創廣告設計公司',
    desc: '協助完成各類廣告視覺設計，包含平面廣告、展場設計及數位廣告素材，磨練各種設計軟體的操作能力。',
    type: 'work',
  },
  {
    period: '2016 — 2020',
    role: '視覺傳達設計學系 學士',
    company: '國立臺灣藝術大學',
    desc: '主修視覺傳達設計，副修攝影藝術。在校期間多次獲得系內設計競賽優等獎，並擔任系學會美術部長。',
    type: 'edu',
  },
];
